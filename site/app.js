...
const decisions={
 execution:{title:'Continuous 2/2; Linear29 1/2. The farther-goal choice is lost.',evidence:'All four native cases are complete. At tick 126, Linear29 requests the loop but misses the required clearance by 1.07 mm. Clearance opens at 134 without a second check. It follows short, recovers and slows outside the goal; no contact or fall occurs.',question:'Can a pending request wait for clearance within a valid commitment window and preserve the complete task?',test:'First prove the shared-prefix deadline. Then separately register original/farther goals × continuous/Linear29 with bounded clearance admission, reusing the current four incumbent cases. Keep the codec, motor, predictor, 2 cm clearance and 3D goal threshold fixed.',pivot:'Successful delayed execution would support a timing bottleneck in this task. Failure after admission requires separate loop-support and codec-component checks. A future blend cannot cause a pre-decision gate failure. Later gate opening and calibrated shadows are not physical repairs.'},
