...
const decisions={
 execution:{title:'Both simple routes complete the prescribed task.',evidence:'New complete-task pilot: continuous 4/4 and Linear29 with reset anchors 4/4. Four paired initial states, histories and dynamics match exactly; complete future references remain supplied.',question:'Does this support survive switching from an actual incoming state?',test:'Freeze qualified lowering, entry, exit and braking states with complete controller history; compare continuous and Linear29 continuations before training a new codec.',pivot:'If only a codec loses supported continuations, study its information loss. If both fail, repair switching support; if both pass, test the causal composer.'},
