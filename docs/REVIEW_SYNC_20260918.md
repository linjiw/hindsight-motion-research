...
- Evidence snapshots and carrier provenance remained unchanged. Native experiments and the Python research test suite were not rerun for this documentation/static-site change.
